...
import { getEstablishments } from '@store/establishment-store/actions';
import { selectIsLoadingGetEstablishments } from '@store/establishment-store/selectors';
import { clickButtonRefreshInit, getDocumentTypes, getPlanes } from '@store/general-store/actions';
...
import { getPlan } from '@store/local-store/actions';
import { selectIsLoadingGetPlan } from '@store/local-store/selectors';
import { getModules, getModulesEnabled } from '@store/module-store/actions';
