...
public class AnalisisController {
	...
	public ResponseEntity<ResponseResultadoPonderacion> resultadoPonderacion(@RequestParam Integer idProyecto) {
		return ResponseEntity.ok(service.resultadoPonderacion(idProyecto));
	}
}
