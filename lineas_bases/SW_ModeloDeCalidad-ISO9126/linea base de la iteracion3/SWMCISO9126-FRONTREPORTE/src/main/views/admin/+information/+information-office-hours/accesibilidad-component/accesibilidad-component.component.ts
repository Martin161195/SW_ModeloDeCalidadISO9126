...
@Component({
  selector: 'app-accesibilidad-component',
  templateUrl: './accesibilidad-component.component.html'
})
export class AccesibilidadComponent implements OnInit {
  ...
  constructor(
    ...
    this.subcaracteristicas = [
      {
        id: 40,
        nombre: 'Accesibilidad para usuarios con discapacidad'
      },
      {
        id: 41,
        nombre: 'Adecuación de los idiomas admitidos'
      }
    ];
