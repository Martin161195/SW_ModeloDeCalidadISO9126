...
@Component({
  selector: 'app-operabilidad-component',
  templateUrl: './operabilidad-component.component.html'
})
export class OperabilidadComponent implements OnInit {
  ...
  constructor(
    ...
    this.subcaracteristicas = [
      {
        id: 27,
        nombre: 'Consistencia operacional'
      },
      {
        id: 28,
      ...
      {
        id: 29,
        nombre: 'Customizacion funcional'
      },
      {
        id: 30,
        nombre: 'Customizacion de la interface de usuario'
      },
      {
        id: 31,
        nombre: 'Capacidad de monitoreo'
      },
      {
        id: 32,
        nombre: 'Capacidad de deshacer acciones'
      },
      {
        id: 33,
        nombre: 'Categorizacion de la informacion entendible'
      },
      {
        id: 34,
        nombre: 'Consistencia de la apariencia de las interfaces de usuario'
      },
      {
        id: 35,
        nombre: 'Soporte de dispositivos de entrada'
      }
    ];
